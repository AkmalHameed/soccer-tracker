defmodule SoccerTrackerWeb.Layouts do
  ...
  def app(assigns) do
    ...
    <%= if @current_scope do %>
      ...
      <a href={~p"/sessions/new"} class="flex flex-col items-center gap-1 px-3 py-1 rounded-xl hover:bg-base-300 transition-colors">
        <span class="text-xl">⚽</span>
        <span class="text-xs opacity-70">Log</span>
      </a>
