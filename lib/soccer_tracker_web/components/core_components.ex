defmodule SoccerTrackerWeb.CoreComponents do
  use Phoenix.Component
  use Gettext, backend: SoccerTrackerWeb.Gettext
  ...
  def flash(assigns) do
    ...
    <div
      ...
      phx-mounted={JS.hide(to: "##{@id}", transition: {"transition-opacity duration-1000", "opacity-100", "opacity-0"}, time: 5000)}
      role="alert"
  ...
  def translate_error({msg, opts}) do
    if count = opts[:count] do
      Gettext.dngettext(SoccerTrackerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SoccerTrackerWeb.Gettext, "errors", msg, opts)
    end
  end
